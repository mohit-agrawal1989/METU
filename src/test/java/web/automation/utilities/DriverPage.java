...
public abstract class  DriverPage extends BrowserConfiguration{
	...
	public String getText(String locator){
		...
		String text = getWebDriver().findElement(By.xpath(locator)).getText();	
		return text;
	}
	...
	public void scrollIntoView(String locator){
		  ...
		  ((JavascriptExecutor)getWebDriver()).executeScript("arguments[0].scrollIntoView(true);", new Object[] { elem });
		 }
